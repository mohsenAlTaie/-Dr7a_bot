...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = (
        "⚡️ هــــلا بـوحش التحميل الغامض ⚙️🖤\n\n"
        "🚀 *مرحباً بك في أعظم بوت تحميل على الإطلاق!*\n"
        "🎭 هنا تتحول الروابط إلى فيديوهات بلمسة واحدة.\n"
        "🧠 يعمل بالذكاء الصناعي ويدعمه الجن الرقمي.\n"
        "🌀 فقط أرسل رابط من TikTok أو YouTube أو Facebook أو Instagram... وخلي الباقي عليّ!\n\n"
        "✨ هل أنت VIP؟ إنطلق بلا حدود!"
    )
